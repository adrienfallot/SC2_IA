...
void SoldierManager::DetermineActionForIdleSoldiers(Bot* bot)
{
	...
	std::cout << "number of idle marines" << number_of_idle_marines_ << " --- " << enought_marines_for_attack << std::endl;
	bool enought_sneeky_marines_for_attack = (number_of_sneeky_idle_marines_ >= number_min_of_sneeky_marines_to_attack_);
	std::cout << "number of sneeky" << number_of_sneeky_idle_marines_ << " --- " << enought_sneeky_marines_for_attack << std::endl;
